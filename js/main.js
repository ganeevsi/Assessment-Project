        ...
        <div class="card border-primary mb-3" style="max-width: 100rem;">
          ...
          <div class="card-body">
            ...
            <div class="col-md-9">
              ...
              <span class="badge badge-success"><a href="https://github.com/${username}/followers" target="_blank" class="text-white">Followers: ${user.followers}</a></span>
              <span class="badge badge-info"><a href="https://github.com/${username}/following" target="_blank" class="text-white">Following: ${user.following}</a></span>
              <br><br>
              <ul class="list-group">
